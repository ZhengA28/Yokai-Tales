...
public partial class Grid : Control
{
	...
	private PackedScene[] orbType = [
		GD.Load<PackedScene>("res://Objects/Orbs/BlueOrb.tscn"),
		GD.Load<PackedScene>("res://Objects/Orbs/GreenOrb.tscn"),
		GD.Load<PackedScene>("res://Objects/Orbs/RedOrb.tscn"),
		GD.Load<PackedScene>("res://Objects/Orbs/WhiteOrb.tscn"),
		GD.Load<PackedScene>("res://Objects/Orbs/YellowOrb.tscn")
	...
	private enum STATE {Move, Wait};	//Enum for state machine
	private STATE state;
	private bool swapped = false;	//Orbs that are swapped but no match
	private Random rand;
